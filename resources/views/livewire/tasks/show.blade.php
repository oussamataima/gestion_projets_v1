...
new class extends Component {
    ...
    public function start_task()
    {
        ...
        $this->toast(type: 'warning', title: 'The task has started', timeout: 3000);
    }
    public function end_task()
    {
        ...
        // dd($hoursDifference);
        $earned_points = (($this->task->estimated_completion_time - $hoursDifference) * $this->task->task_points) / $this->task->estimated_completion_time;
        ...
        $this->toast(type: 'success', title: 'Task has been completed!', description: null, position: 'toast-top toast-end', css: 'alert-success', timeout: 4500, redirectTo: null);
    }
}; ?>
...
<div>
    <div class="flex justify-between items-baseline mb-8">
        ...
        <x-badge value="{{ $task->status }}" @class([
    ...
    <div class="my-4">
        ...
        <h3 class="text-lg">Estimated completion time: <span class="font-bold">{{ $task->estimated_completion_time }}
                hrs </span></h3>
        @if ($task->status === 'completed')
